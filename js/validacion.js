...
window.addEventListener('click', ()=> {
    ...
    const validaCampos = ()=> {
        ...
        if(usuarioValor==null){
            validaFalla(usuario, 'Campo vacío ingrese datos')
        }else{
            validaOk(usuario)
        }
        ...
        if(!emailValor){
            validaFalla(email, 'Campo vacío ingrese datos')            
         ...
         if(!passValor) {
             ...
             validaFalla(pass, 'Debe tener mayusculas, minuscuas, numeros')
         } else {
             validaOk(pass)
         }
